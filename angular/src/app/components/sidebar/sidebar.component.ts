...
export class SidebarComponent implements OnInit {
    ...
    ngOnInit() {
        this.items = [
            ...
            items: [
                {label: 'Account',icon:'pi pi-fw pi-chevron-right', routerLink: ['/account']},
                {label: 'Transaction',icon:'pi pi-fw pi-chevron-right', routerLink: ['/transaction']},
                {label: 'Type',icon:'pi pi-fw pi-chevron-right', routerLink: ['/type']},
                {label: 'AuditRegister',icon:'pi pi-fw pi-chevron-right', routerLink: ['/audit-register']},
