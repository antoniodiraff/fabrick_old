...
public class ProxyUtil {
	 ...
	 */
	public ResponseEntity<SandBoxBaseResponse> restCall(String api, HttpMethod httpMethod, Map<String, String> params, Object request) {
		...
		try {
			...
			if(request!=null) {
			    ...
			    responseEntity = restTemplate.exchange(url, httpMethod, new HttpEntity<>("parameters", headers), SandBoxBaseResponse.class, params);
			}
